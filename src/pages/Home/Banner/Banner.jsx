        ...
        <div className='my-5 '>
            <div className="carousel w-full rounded-lg">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="/public/sliderImg-3 (1).jpg" className="w-full" />
                    <div className='absolute '>
                        <h2 className="text-6xl font-bold my-2 mx-2 text-yellow-400">Get Affordable Toys</h2>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="/public/sliderImg-2 (1).jpg" className="w-full" />
                    <div className='absolute text-white'>
                        <h2 className="text-6xl font-bold my-2 mx-2">Get Awesome Toys</h2>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="/public/sliderImg-1 (1).jpg" className="w-full" />
                    <div className='absolute'>
                        <h2 className="text-6xl font-bold my-2 mx-2 text-yellow-400">Get Latest Toys</h2>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img src="/public/sliderImg-4 (1).jpg" className="w-full" />
                    <div className='absolute '>
                        <h2 className="text-6xl font-bold my-2 mx-2 text-yellow-400">Get Amazing Toys</h2>
